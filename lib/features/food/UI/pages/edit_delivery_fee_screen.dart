...
class EditDeliveryScreen extends StatelessWidget {
  const EditDeliveryScreen({Key? key}) : super(key: key);

  static final RiderRepo riderRepo = locator<RiderRepo>();
  static TextEditingController feeTextEditingController =
      TextEditingController();
  static TextEditingController regionTextEditingController =
      TextEditingController();
  static TextEditingController areaNameTextEditingController =
      TextEditingController();
  ...
  void send(BuildContext context) async {
    ...
    try {
      ...
      await RiderRepo().changeDeliveryFee(fee);
      loading.value = false;
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const HeaderWidget(iconData: null, title: 'Change Delivery Fee'),
            SizedBox(height: sizerSp(30.0)),
            const SizedBox(height: 20.0),
            StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                stream: riderRepo.deliveryFeeStream(),
                builder: (
            ...
            CustomTextWidget(
              text: 'Above is the current delivery fee per kilo-meter',
            ...
            CustomTextField(
              ...
              hintText: 'Change Delivery Fee per kilometer',
              labelText: 'Delivery Fee',
              validator: (String? text) =>
                  formFieldValidator(text, 'Delivery Fee', 1),
            ),
            const Spacer(),
