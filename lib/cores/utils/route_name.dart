class RouteName {
  ...
  static const String sendNotificationPageScreen = 'send-notification-page';
  static const String editDeliveryScreen = 'editDeliveryScreen';
  static const String editRiderFee = 'editRiderFee';
  ...
  static const String fastFoodScreen = 'fast-food-page';
  static const String selectedfastFoodScreen = 'selected-fast-food-page';
  static const String addfastFoodScreen = 'add-fast-food-page';
  static const String addMarketItemScreen = 'add-market-item-page';
  static const String addNewFoodScreen = 'add-new-food-page';
}
